      ...
      <div className="container-custom py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-2xl font-bold text-gradient mb-4">🍽️ Quán Ăn Ngon</h3>
            <p className="text-neutral-300 leading-relaxed">
              Nơi quy tụ tinh hoa ẩm thực Việt Nam với không gian ấm cúng 
              và dịch vụ tận tâm.
            </p>
          ...
          <div className="space-y-4">
            ...
            <nav className="space-y-2">
              ...
              <Link href="/thuc-don" className="block text-neutral-300 hover:text-white transition-colors">
                Thực Đơn
              </Link>
              <Link href="/thuc-uong" className="block text-neutral-300 hover:text-white transition-colors">
                Nước Uống
              </Link>
              <Link href="/dat-ban" className="block text-neutral-300 hover:text-white transition-colors">
                Đặt Bàn
              </Link>
              <Link href="/lien-he" className="block text-neutral-300 hover:text-white transition-colors">
                Liên Hệ
              </Link>
            </nav>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <a href="tel:+84123456789" className="text-neutral-300 hover:text-white transition-colors text-sm">
                  +84 123 456 789
                </a>
              </div>
              <div className="flex items-center space-x-3">
                ...
                <a href="mailto:info@quananngon.com" className="text-neutral-300 hover:text-white transition-colors text-sm">
                  info@quananngon.com
                </a>
              </div>
            </div>
      ...
      <div className="border-t border-neutral-700">
        <div className="container-custom py-4">
          <div className="flex flex-col md:flex-row justify-between items-center text-sm text-neutral-400">
            <p>&copy; 2024 Quán Ăn Ngon. Tất cả quyền được bảo lưu.</p>
